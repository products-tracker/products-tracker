...
class Products extends React.Component {
  ...
  click = () => {
    ...
    this.props.modal_on({image_src: this.props.image, title: this.props.title, price: this.props.price, description: this.props.description, category: this.props.category})
  }
